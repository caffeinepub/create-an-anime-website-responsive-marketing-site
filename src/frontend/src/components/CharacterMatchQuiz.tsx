...
const quizQuestions: QuizQuestion[] = [
    ...
    answers: [
      {
        ...
        traits: ["protective", "loyal", "moon"],
      },
      {
        text: "Proving my strength and power",
        traits: ["ambitious", "fire", "sun"],
      },
      {
        text: "Seeking knowledge and wisdom",
        traits: ["wise", "calm", "moon"],
      },
      {
        text: "Supporting and helping others",
        traits: ["kind", "supportive", "earth"],
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "Endure quietly and persist",
        traits: ["quiet", "enduring", "moon"],
      },
      {
        text: "Work together with others",
        traits: ["supportive", "kind", "earth"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "Earth - Stability and support",
        traits: ["earth", "supportive"],
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "I carry a hidden potential I must discover",
        traits: ["moon", "quiet"],
      },
      {
        text: "I will become the strongest through effort",
        traits: ["fire", "energetic"],
      },
      {
        text: "I will support others on their journey",
        traits: ["earth", "supportive"],
      },
...
export function CharacterMatchQuiz({ onComplete }: CharacterMatchQuizProps) {
  ...
  const handleNext = () => {
    ...
    newAnswers[currentQuestion] =
      quizQuestions[currentQuestion].answers[selectedAnswer].traits;
  ...
  const calculateMatch = (userAnswers: string[][]) => {
    ...
    const scores = animeSiteConfig.characters.map((character) => {
      ...
      const matchCount = allTraits.filter((trait) =>
        profile.includes(trait),
      ).length;
      return {
        character,
        score: matchCount,
