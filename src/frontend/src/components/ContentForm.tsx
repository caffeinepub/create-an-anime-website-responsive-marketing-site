    ...
    <div>
          ...
          <div>
            ...
            <p className="text-sm admin-muted-text">
              {isEditing
                ...
                : "Fill in the content details below"}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="space-y-1.5">
            ...
            <SelectContent className="admin-select-content">
              {CONTENT_TYPES.map((type) => (
                <SelectItem
                  key={type}
                  value={type}
                  className="capitalize admin-select-item"
                >
          ...
          />
          {errors.contentType && (
            <p className="text-xs text-red-400">{errors.contentType.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          <Label className="admin-label">
            Image URL{" "}
            <span className="admin-muted-text font-normal">(optional)</span>
          </Label>
          <Input
            className="admin-input"
            placeholder="https://..."
