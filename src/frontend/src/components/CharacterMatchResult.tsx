...
export function CharacterMatchResult({
  match,
  onRestart,
}: CharacterMatchResultProps) {
  ...
  if (
    ...
    (typeof character.age === "string" && character.age !== "")
  ) {
  ...
  const imageSrc =
    "imageSrc" in character
      ? (character.imageSrc as string | undefined)
      : undefined;
  const hasImage =
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-foreground/70 text-lg">{percentage}% Match</p>
      </div>
      ...
      <div className="bg-muted/50 border-2 border-foreground/10 rounded-lg p-6 mb-8">
        ...
        <p className="text-foreground/80 leading-relaxed">
          Based on your answers, you share key personality traits and values
          with {character.name}. Your responses about{" "}
          {getMatchReason(character.name)} align perfectly with their character
          profile in Whispers of the White Moon.
        </p>
      </div>
