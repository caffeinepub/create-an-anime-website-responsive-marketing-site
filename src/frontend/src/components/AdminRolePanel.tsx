...
export function AdminRolePanel() {
  ...
  return (
    <div className="admin-panel-roles rounded-lg p-4 -m-4">
      {/* Panel Header */}
      ...
      <div className="grid gap-6 max-w-2xl">
        ...
        <div className="admin-card rounded-xl p-6">
          ...
          <p className="text-xs admin-muted-text mb-3">
            Share this with other admins if you need to be granted additional
            roles.
          </p>
          <div className="admin-surface rounded-lg p-3 flex items-center gap-2">
            <span className="flex-1 text-xs font-mono admin-muted-text break-all">
              {principal}
            </span>
            <button
              type="button"
        ...
        <div className="admin-card rounded-xl p-6">
          ...
          <p className="text-xs admin-muted-text mb-4">
            Enter a principal ID to grant admin access to another user. They
            will be able to manage all content.
          </p>
        ...
        <div className="flex items-start gap-3 bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
          ...
          <div>
            ...
            <p className="text-xs admin-muted-text mt-1">
              Admin users have full access to create, edit, and delete all
              content including episodes, characters, and site content. Only
