...
import type { ContactRequest as _ContactRequest, NewRequest as _NewRequest, Time as _Time, Topics as _Topics, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getRequestsByTopic(arg0: Topics): Promise<Array<ContactRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestsByTopic(to_candid_Topics_n14(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRequest(arg0: NewRequest): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRequest(to_candid_NewRequest_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_NewRequest_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NewRequest): _NewRequest {
    return to_candid_record_n19(_uploadFile, _downloadFile, value);
}
function to_candid_Topics_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Topics): _Topics {
...
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        topic: to_candid_Topics_n14(_uploadFile, _downloadFile, value.topic),
        email: value.email,
        message: value.message
    };
}
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Topics): {
    businessPartnerships: null;
} | {
    interviewRequests: null;
} | {
