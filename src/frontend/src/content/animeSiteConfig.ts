  ...
  worldbuilding: {
    ...
    shiranagFamily: {
      ...
      father: {
        ...
        details:
          "Holder of the Power of the Moon. Killed by the Sunseekers when Kazeyori was 5. His power was passed to Kazeyori, who does not know this.",
      },
      mother: {
  ...
  characters: [
    {
      ...
      powerState:
        "No techniques, no awakened power. Has Tsukinome (inactive, unknown to him)",
    ...
    },
    {
      ...
      rank: 9,
      design:
        "Muscular, athletic build with 6-pack, messy red hair, green kimono, blue sneakers",
      personality: "Energetic and determined",
      weapon: "Black sword with fire patterns and red handle",
      powerState:
        "No techniques, no awakened power. Has Hinome (inactive, unknown to him)",
    ...
    },
    {
      ...
      rank: 10,
      design:
        "Thin, petite build, black hair with bangs, pink kimono, pink sneakers",
      personality: "Kind and supportive",
      weapon: "Golden staff with 地球 (Earth) carved on it, can change length",
      powerState:
        "No techniques, no awakened power. Has Chikyonome (inactive, unknown to her)",
    ...
    },
    {
      ...
      powerState:
        "Master of Moon Clan techniques. Has fully awakened Tsukinome",
    ...
    },
    {
      ...
      rank: "Sunk King",
      design:
        "Fiery hair, extremely muscular with 8-pack, big biceps and triceps, fire-colored grim reaper-style suit, sandals",
      personality: "Ruthless and powerful",
      weapon: "Yellow staff with a mini sun on top",
      powerState:
        "Extremely powerful. Powers: Gravity Control, U.V Ray, God Ray, Eternal Noon, Supernova Collapse (strongest)",
    ...
    },
    {
      ...
      weapon: "Solar whip",
      powerState:
        "Skilled warrior with mastery of her solar whip. Has Taiyonome (Sun Clan eye)",
  ...
  episodes: [
    {
      ...
      synopsis:
        "The story begins with Kazeyori Shiranagi, a quiet and lonely boy living in the Moon Village. We follow his daily life, witnessing his struggles with weakness and isolation. No battles occur—just a glimpse into the life of a boy who doesn't yet know his destiny.",
    ...
    },
    {
      ...
      synopsis:
        "Sankei and Haruna arrive in the Moon Village and meet Kazeyori, asking for directions. Introductions lead to a natural friendship forming. After they leave, Kazeyori eats at a local restaurant while Sankei and Haruna discuss him extensively on their journey back.",
      videoSourceUrl: undefined,
    },
    {
      number: 3,
