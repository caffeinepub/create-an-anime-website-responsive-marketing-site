...
import type { Character as _Character, ContactRequest as _ContactRequest, Content as _Content, Episode as _Episode, NewContent as _NewContent, NewRequest as _NewRequest, Time as _Time, Topics as _Topics, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCharacter(arg0: NewCharacter): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createContent(arg0: NewContent): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createContent(to_candid_NewContent_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createEpisode(arg0: NewEpisode): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getContent(arg0: string): Promise<Content | null> {
        if (this.processError) {
            try {
    ...
    async getRequestsByTopic(arg0: Topics): Promise<Array<ContactRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestsByTopic(to_candid_Topics_n22(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRequest(arg0: NewRequest): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRequest(to_candid_NewRequest_n26(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCharacter(arg0: string, arg1: NewCharacter): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateContent(arg0: string, arg1: NewContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContent(arg0, to_candid_NewContent_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEpisode(arg0: string, arg1: NewEpisode): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_ContactRequest_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ContactRequest): ContactRequest {
    return from_candid_record_n11(_uploadFile, _downloadFile, value);
}
function from_candid_Content_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Content): Content {
    return from_candid_record_n7(_uploadFile, _downloadFile, value);
}
function from_candid_Topics_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Topics): Topics {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Character]): Character | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Content]): Content | null {
    return value.length === 0 ? null : from_candid_Content_n6(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Episode]): Episode | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        topic: from_candid_Topics_n12(_uploadFile, _downloadFile, value.topic),
        email: value.email,
...
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Content>): Array<Content> {
    return value.map((x)=>from_candid_Content_n6(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ContactRequest>): Array<ContactRequest> {
    return value.map((x)=>from_candid_ContactRequest_n10(_uploadFile, _downloadFile, x));
}
function to_candid_NewContent_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NewContent): _NewContent {
    return to_candid_record_n4(_uploadFile, _downloadFile, value);
}
function to_candid_NewRequest_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NewRequest): _NewRequest {
    return to_candid_record_n27(_uploadFile, _downloadFile, value);
}
function to_candid_Topics_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Topics): _Topics {
...
function to_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        topic: to_candid_Topics_n22(_uploadFile, _downloadFile, value.topic),
        email: value.email,
        message: value.message
    };
}
...
function to_candid_variant_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Topics): {
    businessPartnerships: null;
} | {
    interviewRequests: null;
} | {
